...
<div class="entry_content">
    ...
    <?php if ($this->item->extra_fields['articleSource']->value):?>
        <div class="name"><?php echo JText::_('TPL_Z201_ARTICLE_SOURCE'); ?>： <a target="_blank" href="<?php echo $this->item->extra_fields['articleSourceLink']->value;?>"><?php echo $this->item->extra_fields['articleSource']->value;?></a></div>
    <?php endif;?>
