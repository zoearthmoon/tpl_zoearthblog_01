...
jQuery(function(){
	jQuery("#zoearthcontactusindex_form").validate();
});
</script>
<div class="consulting">
    <div class="header">請填寫您的資料，讓我們與您聯繫</div>
    <div class="horizontal-form" id="contact-form-container">
        <form method="post" id="zoearthcontactusindex_form" name="zoearthcontactusindex_form" target="addIframe" method="post" action="<?php JRoute::_('index.php'); ?>" >
        ...
        <?php if ($useValidate):?>
            <div class="control-group" >
                ...
                <div class="control-input">
                    ...
                    <img style="float: right" src="<?php echo JURI::root().'index.php?option=com_zoearthcontactus&controller=verifycode&time='.time(); ?>">
                </div>
